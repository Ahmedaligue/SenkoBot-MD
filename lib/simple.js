...
N:${name.replace(/\n/g, '\\n')}
FN:${name.replace(/\n/g, '\\n')}
TELtype=CELLtype=VOICEwaid=${number}:${PhoneNumber('+' + number).getNumber('international')}${biz.description ? `
...
FN:${name.replace(/\n/g, '\\n')}
item.ORG:${isi}
item1.TELwaid=${number}:${PhoneNumber('+' + number).getNumber('international')}
item1.X-ABLabel:${isi1}
${isi2 ? `item2.EMAILtype=INTERNET:${isi2}\nitem2.X-ABLabel:📧 Email` : ''}
${isi3 ? `item3.ADR:${isi3}\nitem3.X-ABADR:ac \nitem3.X-ABLabel:📍 Region` : ''}
${isi4 ? `item4.URLtype=pref:${isi4}\nitem4.X-ABLabel:Website` : ''}
${extraLinks.map((link, index) => link ? `item${index + 5}.URLtype=pref:${link}\nitem${index + 5}.X-ABLabel:Extra Link ${index + 1}` : '').join('\n')}
